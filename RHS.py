...
class RHS:
    ...
    def __init__(self, lstm_size=[800], layer=[10]):
        self.bidirectional_rnn = BidirectionalRNN('BidirectionalRNN', lstm_size)
        self.logistic_regression = LogisticRegression('LogisticRegression', lstm_size[-1], layer)
